...
const features = [
    {
        icon: Leaf,
        title: "100%",
        subtitle: "Ingredientes Naturales",
        description: "Sin aditivos artificiales ni conservadores",
        accent: "#7ecc5c",
    },
    {
        icon: Droplets,
        ...
        description: "Todo el beneficio, sin azúcar agregada",
        accent: "#5BA840",
    },
    {
        icon: Shield,
        ...
        description: "Fabricado bajo los más altos estándares",
        accent: "#7ecc5c",
    },
    {
        icon: Heart,
        title: "240",
        subtitle: "Cápsulas por Frasco",
        description: "Mayor rendimiento por producto",
        accent: "#5BA840",
    },
]
...
function FeatureCard({ feature, index }: { feature: (typeof features)[0]; index: number }) {
    ...
    return (
        ...
        >
            ...
            {/* Card */}
            <div className="relative bg-[#1a1a1a] rounded-2xl p-6 border border-white/10 overflow-hidden h-full">
                {/* Shine effect */}
                <motion.div
...
export function BentoGrid() {
    ...
    return (
        <section id="formula" className="relative py-16 bg-[#121212] overflow-hidden">
            ...
            <div ref={ref} className="max-w-[1400px] mx-auto px-8 lg:px-12 relative z-10">
                <motion.div
                    initial={{ opacity: 0 }}
